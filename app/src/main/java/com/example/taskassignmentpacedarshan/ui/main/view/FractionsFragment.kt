...
import com.example.taskassignmentpacedarshan.databinding.FragmentFractionsBinding
...
class FractionsFragment :BaseFragment(){
    private val mainFragmentViewModel : MainFragmentViewModel by inject()
    private var binding : FragmentFractionsBinding?=null
    ...
    override fun onCreateView(
        ...
        binding  = DataBindingUtil.inflate(inflater, R.layout.fragment_fractions,container,false)
